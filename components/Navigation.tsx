...
export default function Navigation() {
    ...
    const activeElemnet = 'bg-blue-500 text-white -mx-10 px-10 rounded-md shadow-md shadow-gray-300 z-20';
    const nonActiveElement = '-mx-4 px-4 rounded-md hover:bg-blue-500/20 hover:shadow-md hover:shadow-gray-300 transition-all hover:scale-110 -z-10';
